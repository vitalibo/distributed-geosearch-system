...
public class WritableStreamDecoratorTest extends TestTopology {
    ...
    public void testWriteTo() {
        ...
        WritableStreamDecorator<String, String, String, Integer> decorator =
            new WritableStreamDecorator<>(outputTopic, (k, v) -> IntStream.range(0, v)
