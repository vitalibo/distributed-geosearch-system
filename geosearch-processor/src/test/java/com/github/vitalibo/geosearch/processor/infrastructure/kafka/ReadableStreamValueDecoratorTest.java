...
public class ReadableStreamValueDecoratorTest extends TestTopology {
    ...
    public void testStream() {
        ...
        ReadableStreamValueDecorator<String, Integer, Long> decorator =
            new ReadableStreamValueDecorator<>(inputTopic, v -> Arrays.asList((long) v / 2L, (long) v, v * 2L));
